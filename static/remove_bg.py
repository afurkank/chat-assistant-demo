...
with open('/home/af-karacik/chat-assistant/static/avatar.png', 'rb') as f:
    image_bytes = f.read()

bg_removed = get_bg_removed_img(image_bytes)

with open('/home/af-karacik/chat-assistant/static/bg_removed_avatar.png', 'wb') as f:
    f.write(bg_removed)